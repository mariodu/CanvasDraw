...
$(function() {
    ...
    function init(text) {
        ...
        var hexphrase= phraseToHex(text);
    ...
    function updateCanvasDimensions() {
        canvas.attr({height: "500", width: "940"});
    ...
    function Point(x, y, z, size, colour) {
        ...
        this.radius = size;
        this.size = size;
        this.springStrength = 0.1; //弹性
        this.targetPos = new Vector(x, y, z);
        this.velocity = new Vector(0.0, 0.0, 0.0); //速率
